...
- [nixpig/syringe.sh](https://github.com/nixpig/syringe.sh) ([0.0.4](https://github.com/nixpig/syringe.sh/releases/tag/0.0.4), 2 days ago) - 🔐 Self-hostable distributed database-per-user encrypted secrets management over SSH.
...
- [anthdm/superkit](https://github.com/anthdm/superkit) -  (3 days ago)
