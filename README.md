...
- [nixpig/syringe.sh](https://github.com/nixpig/syringe.sh) ([0.0.12](https://github.com/nixpig/syringe.sh/releases/tag/0.0.12), today) - 🔐 Self-hostable distributed database-per-user encrypted secrets management over SSH.
